                    ...
                    <?php if (isset($_SESSION['is_admin']) && $_SESSION['is_admin']): ?>
                        <li>
                            <a href="/admin/index.php" class="relative group" data-title="Aller à l'Administration">
                                <img class="relative z-100 inset-0 w-7.5 h-7.5 animate-bounce transition-opacity duration-300 group-hover:opacity-0" src="/assets/img/adminGray-logo.svg" />
                                <img class="absolute z-10 inset-0 w-7.5 h-7.5 opacity-0 group-hover:opacity-100 transition-opacity duration-300 group-hover:scale-110" src="/assets/img/adminOrange-logo.svg" />
                            </a>
                        </li>
                    <?php endif; ?>
                    <li>
